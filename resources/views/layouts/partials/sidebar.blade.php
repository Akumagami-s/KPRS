<div class="sidebar-wrapper">
    ...
    <div class="logo-wrapper">
        <a href="{{ route('home') }}"><img class="img-fluid" src="{{ asset('assets/images/fixlogo.png') }}" alt="logo TNI AD" style="width: 90px; object-fit: cover;"></a>
        <a href="{{ route('home') }}"><img class="img-fluid" src="{{ asset('assets/images/btnlogo.jpg') }}" alt="logo TNI AD" style="width: 90px; object-fit: cover;"></a>
        <div class="back-btn"><i class="fa fa-angle-left"></i></div>
        <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
    </div>
    <div class="logo-icon-wrapper">
        <a href="{{ route('home') }}"><img class="img-fluid" src="{{ asset('assets/images/logoijo.png') }}" alt="logowebsite" style="height: 20px; width: 20px; object-fit: cover;"></a>
    </div>
    @if (auth()->user()->role == '0')
    <nav class="sidebar-main">
        ...
        <div id="sidebar-menu">
            <ul class="sidebar-links custom-scrollbar">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="bookmark"></i><span>Data KPR</span>
                    </a>
                    <ul class="sidebar-submenu">
                        ...
                        <li><a href="{{ route('admin.detaildata.pinjam', 'tunggakan') }}">Data Tunggakan</a></li>
                        <li><a href="{{ route('admin.detaildata.pinjam', 'piutang') }}">Data Piutang</a></li>
                        <!--<li><a href="{{ route('admin.detaildata.pinjam', 'history') }}">History</a></li>-->
                        <li><a href="{{ route('admin.detaildata.report.global') }}">Report Global</a></li>
                    </ul>
                </li>
                <!--<li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="book-open"></i><span>Update Data KPR</span></a>-->
                   <!--<ul class="sidebar-submenu">-->
                       <!--<li><a href="{{ route('admin.rekapdata.tahun') }}">Pertahun</a></li>-->

                        <!--<li><a href="{{ route('admin.detaildata.refreshsaldo') }}">Posting Saldo</a></li>-->
                        <!--<li><a href="{{ route('admin.detaildata.refreshpiutang') }}">Posting Piutang</a></li>-->
                   <!--</ul> -->
                <!--</li>-->
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="home"></i><span>Management Rumah</span></a>
                   <ul class="sidebar-submenu">
                        <li><a href="{{ route('admin.rumah.index') }}">Data Rumah</a></li>
        ...
        <div id="sidebar-menu">
            <ul class="sidebar-links custom-scrollbar">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ route('kalkulator') }}"><i data-feather="dollar-sign"></i><span>Kalkulator
                            KPR</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ route('userpinjam.index') }}"><i data-feather="file-plus"></i><span>Pinjaman</span></a></li>
