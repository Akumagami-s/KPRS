@extends('layouts.app', ['title' => 'KPR | Detail Rumah'])
@section('content')
<div>
    <div class="row">
        <div class="col-lg-7">
                            ...
                            @for($i=0; $i < count($gbr); $i++)
                                @if ($gbr[$i] != null)
                                    <div class="carousel-item {{ $i == 0 ? 'active' : '' }}">
                                        <img class="d-block" src="{{ asset('gambar_rumah/'. $gbr[$i]) }}" alt="Foto Rumah"
                                            style="object-fit: contain; object-position: center; width: 100%; max-height: 230px;">
                                    </div>
                                @endif
                            @endfor
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                <table class="product-page-width">
                                    <tbody>
                                        <tr>
                                            <td style="width: 120px"> <b>Deskripsi </b></td>
                                            <td style="width: 35px" align="center">:</td>
                                            <td>{{ $rumah->deskripsi }}</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 120px"> <b>Alamat </b></td>
                                            <td style="width: 35px" align="center">:</td>
                                            <td>{{ $rumah->alamat }}</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 120px"> <b>Luas Bangunan </b></td>
                                            <td style="width: 35px" align="center">:</td>
                                            <td>{{ $rumah->luas_bangunan }} m<sup>2</sup></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 120px"> <b>Luas Tanah </b></td>
                                            <td style="width: 35px" align="center">:</td>
                            ...
                            <div class="m-t-15">
                                <a href="{{ $rumah->link }}" target="_blank" class="btn btn-success m-r-10">Google Maps</a>
                            </div>
                            {{-- <div class="m-t-15">
                                <a href="{{ route('userpinjam.rumah', $rumah->id) }}" class="btn btn-primary m-r-10">Pilih
                                    KPR</a>
                            </div> --}}
                            <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rekening" id="rekening"
                                        class="form-control @error('rekening') is-invalid @enderror" onkeypress="return hanyaAngka(event)" required>
                                    @error('rekening')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="nama_bank" id="nama_bank" class="form-control custom-select @error('nama_bank') is-invalid @enderror" required>
