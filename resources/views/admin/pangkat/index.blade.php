                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="pangkat" id="pangkat"
                                        placeholder="Your Head">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label" for="corps">Coprs:</label>
                                    <input class="form-control" type="text" name="corps" id="corps"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="kesatuan" id="kesatuan"
                                        placeholder="your kesatuan" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label" for="tahap">Tahap:</label>
                                    <input class="form-control" type="number" name="tahap" id="tahap" placeholder="tahap"
                                        required>
                                </div>
                            </div>
                        </div>
