...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.account.register.update', $user->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @endif" type="text" name="name"
                                            value="{{ $user->name ?? old('name') }}" id="name" placeholder="your name"
                                            required>
                                        @error('name')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" type="email"
                                            name="email" value="{{ $user->email ?? old('email') }}" id="email"
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('admin.account.register.index') }}"
